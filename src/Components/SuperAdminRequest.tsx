          ...
          <div className="w-full max-w-4xl bg-white shadow-md rounded-lg">
            <div className="mb-4">
              ...
              <select
                ...
                className="w-full max-w-xs p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent custom-select mr-3"
              >
